...
* **Payload handling**: The library interprets API payloads in a specific manner. It is the user's responsibility to marshal and unmarshal payloads into or from Go structs as needed.
...
if err != nil {
    ...
    // validation failed (e.g., provided bucket name is empty or missing properties in response data)
