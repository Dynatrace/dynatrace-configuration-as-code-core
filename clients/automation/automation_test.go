...
func TestAutomationClient_Update(t *testing.T) {
	...
	t.Run("Update - Fails if payload is invalid", func(t *testing.T) {
		server := testutils.NewHTTPTestServer(t, []testutils.ResponseDef{})
		defer server.Close()

		client := automation.NewClient(rest.NewClient(server.URL(), server.FaultyClient()))
		_, err := client.Update(t.Context(), automation.Workflows, "91cc8988-2223-404a-a3f5-5f1a839ecd45", []byte("invalid data"))

		assert.ErrorContains(t, err, "unable to remove id field")
	})
}
...
func TestAutomationClient_Delete(t *testing.T) {
	...
	t.Run("Delete - adminAccess query parameter set", func(t *testing.T) {
		...
		client := automation.NewClient(rest.NewClient(server.URL(), server.Client()))
		_, _ = client.Delete(t.Context(), automation.Workflows, "91cc8988-2223-404a-a3f5-5f1a839ecd45")
		_, _ = client.Delete(t.Context(), automation.BusinessCalendars, "91cc8988-2223-404a-a3f5-5f1a839ecd45")
	})
