...
import (
	...
	"github.com/dynatrace/dynatrace-configuration-as-code-core/api/clients/filtersegements"
...
func NewClient(client *rest.Client) *Client {
	c := &Client{
		client: filtersegements.NewClient(client),
	}
