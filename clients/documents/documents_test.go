...
func TestDocumentClient_List(t *testing.T) {
	...
	t.Run("List - OK", func(t *testing.T) {
		...
		assert.Nil(t, resp.Responses[0].IsReshareable, "the list endpoint cannot return isReshareable")
		...
		assert.Nil(t, resp.Responses[1].IsReshareable, "the list endpoint cannot return isReshareable")
