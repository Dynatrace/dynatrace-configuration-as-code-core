...
// FilterSegmentsClient creates and returns a new instance of filtersegments.Client for interacting with the grail filter segments API.
func (f factory) FilterSegmentsClient() (*filtersegments.Client, error) {
	restClient, err := f.CreatePlatformClient()
	if err != nil {
		return nil, err
	}
	return filtersegments.NewClient(restClient), nil
}
