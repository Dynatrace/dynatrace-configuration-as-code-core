...
// checks if the ServiceUserDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceUserDto{}
...
type _ServiceUserDto ServiceUserDto

// NewServiceUserDto instantiates a new ServiceUserDto object
...
// NewServiceUserDtoWithDefaults instantiates a new ServiceUserDto object
...
func (o *ServiceUserDto) UnmarshalJSON(data []byte) (err error) {
	...
	varServiceUserDto := _ServiceUserDto{}

	err = json.Unmarshal(data, &varServiceUserDto)

	if err != nil {
		return err
	}

	*o = ServiceUserDto(varServiceUserDto)
...
type NullableServiceUserDto struct {
	value *ServiceUserDto
	isSet bool
}

func (v NullableServiceUserDto) Get() *ServiceUserDto {
	return v.value
}

func (v *NullableServiceUserDto) Set(val *ServiceUserDto) {
	v.value = val
	v.isSet = true
}
...
func NewNullableServiceUserDto(val *ServiceUserDto) *NullableServiceUserDto {
	return &NullableServiceUserDto{value: val, isSet: true}
}
