...
func NewWorkflowRequest(title string) *WorkflowRequest {
...
func (o *WorkflowRequest) GetId() string {
	if o == nil || IsNil(o.Id) {
		var ret string
		return ret
	}
...
func (o *WorkflowRequest) GetIdOk() (*string, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *WorkflowRequest) SetId(v string) {
	o.Id = &v
}

// GetTitle returns the Title field value
func (o *WorkflowRequest) GetTitle() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *WorkflowRequest) GetTitleOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Title, true
...
func (o *WorkflowRequest) SetTitle(v string) {
	o.Title = v
}

// GetTasks returns the Tasks field value if set, zero value otherwise.
func (o *WorkflowRequest) GetTasks() map[string]Task {
...
// and a boolean to check if the value has been set.
func (o *WorkflowRequest) GetTasksOk() (*map[string]Task, bool) {
	if o == nil || IsNil(o.Tasks) {
		return nil, false
	}
	return o.Tasks, true
...
func (o *WorkflowRequest) HasTasks() bool {
	if o != nil && !IsNil(o.Tasks) {
		return true
	}
...
func (o *WorkflowRequest) SetTasks(v map[string]Task) {
	o.Tasks = &v
}

// GetTaskDefaults returns the TaskDefaults field value if set, zero value otherwise.
func (o *WorkflowRequest) GetTaskDefaults() map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *WorkflowRequest) GetTaskDefaultsOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.TaskDefaults) {
...
func (o *WorkflowRequest) HasTaskDefaults() bool {
	if o != nil && !IsNil(o.TaskDefaults) {
		return true
	}
...
func (o *WorkflowRequest) SetTaskDefaults(v map[string]interface{}) {
	o.TaskDefaults = v
}

// GetDescription returns the Description field value if set, zero value otherwise.
func (o *WorkflowRequest) GetDescription() string {
...
// and a boolean to check if the value has been set.
func (o *WorkflowRequest) GetDescriptionOk() (*string, bool) {
	if o == nil || IsNil(o.Description) {
		return nil, false
	}
...
func (o *WorkflowRequest) HasDescription() bool {
	if o != nil && !IsNil(o.Description) {
		return true
	}
...
func (o *WorkflowRequest) GetActorOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WorkflowRequest) HasActor() bool {
...
// and a boolean to check if the value has been set.
func (o *WorkflowRequest) GetOwnerOk() (*string, bool) {
	if o == nil || IsNil(o.Owner) {
		return nil, false
	}
	return o.Owner, true
...
func (o *WorkflowRequest) HasOwner() bool {
	if o != nil && !IsNil(o.Owner) {
		return true
	}
...
func (o *WorkflowRequest) SetOwner(v string) {
	o.Owner = &v
}

// GetOwnerType returns the OwnerType field value if set, zero value otherwise.
func (o *WorkflowRequest) GetOwnerType() string {
...
// and a boolean to check if the value has been set.
func (o *WorkflowRequest) GetOwnerTypeOk() (*string, bool) {
	if o == nil || IsNil(o.OwnerType) {
		return nil, false
	}
...
func (o *WorkflowRequest) HasOwnerType() bool {
	if o != nil && !IsNil(o.OwnerType) {
		return true
	}
...
func (o *WorkflowRequest) SetOwnerType(v string) {
	o.OwnerType = &v
}

// GetIsPrivate returns the IsPrivate field value if set, zero value otherwise.
func (o *WorkflowRequest) GetIsPrivate() bool {
...
// and a boolean to check if the value has been set.
func (o *WorkflowRequest) GetIsPrivateOk() (*bool, bool) {
	if o == nil || IsNil(o.IsPrivate) {
		return nil, false
	}
...
func (o *WorkflowRequest) HasIsPrivate() bool {
	if o != nil && !IsNil(o.IsPrivate) {
		return true
	}
...
func (o *WorkflowRequest) SetIsPrivate(v bool) {
	o.IsPrivate = &v
}

// GetSchemaVersion returns the SchemaVersion field value if set, zero value otherwise.
func (o *WorkflowRequest) GetSchemaVersion() int32 {
...
// and a boolean to check if the value has been set.
func (o *WorkflowRequest) GetSchemaVersionOk() (*int32, bool) {
	if o == nil || IsNil(o.SchemaVersion) {
		return nil, false
	}
...
func (o *WorkflowRequest) HasSchemaVersion() bool {
	if o != nil && !IsNil(o.SchemaVersion) {
		return true
	}
...
func (o *WorkflowRequest) SetSchemaVersion(v int32) {
	o.SchemaVersion = &v
}

// GetTrigger returns the Trigger field value if set, zero value otherwise.
func (o *WorkflowRequest) GetTrigger() TriggerRequest {
...
// and a boolean to check if the value has been set.
func (o *WorkflowRequest) GetTriggerOk() (*TriggerRequest, bool) {
	if o == nil || IsNil(o.Trigger) {
		return nil, false
	}
...
func (o *WorkflowRequest) HasTrigger() bool {
	if o != nil && !IsNil(o.Trigger) {
		return true
	}
...
func (o *WorkflowRequest) SetTrigger(v TriggerRequest) {
	o.Trigger = &v
}
