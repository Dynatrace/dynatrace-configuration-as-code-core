...
// APIClient manages communication with the Grail - Storage Management API v1.0.0
...
type APIClient struct {
	...
	BucketDefinitionsAPI *BucketDefinitionsAPIService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.BucketDefinitionsAPI = (*BucketDefinitionsAPIService)(&c.common)
