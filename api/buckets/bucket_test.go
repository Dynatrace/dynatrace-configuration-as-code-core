...
func TestGet(t *testing.T) {
 ...
 "version": 1
		...
		client := buckets.New(rest.NewClient(server.URL(), server.Client(), testr.New(t)), testr.New(t))
...
func TestList(t *testing.T) {
	...
	t.Run("returns error in case of network error", func(t *testing.T) {
		...
		client := buckets.New(rest.NewClient(server.URL(), faultyClient, testr.New(t)), testr.New(t))
...
func TestUpsert(t *testing.T) {
  ...
  "version": 1
	...
	t.Run("Update fails with conflict only once", func(t *testing.T) {
		...
		client := buckets.New(rest.NewClient(u, server.Client(), testr.New(t)), testr.New(t))
		data := []byte("{}")
...
func TestDelete(t *testing.T) {
  ...
  "version": 1
	...
	t.Run("delete bucket - network error", func(t *testing.T) {
		...
		client := buckets.New(rest.NewClient(server.URL(), server.FaultyClient(), testr.New(t)), testr.New(t))
		resp, err := client.Delete(context.TODO(), "bucket name")
		assert.Error(t, err)
		assert.Zero(t, resp)
	})
...
func TestUpdate(t *testing.T) {
  ...
  "version": 1
	...
	t.Run("update fails", func(t *testing.T) {
		...
		client := buckets.New(rest.NewClient(server.URL(), &http.Client{}, testr.New(t)), testr.New(t))
	...
	t.Run("Update fails with conflict only once", func(t *testing.T) {
		...
		u, _ := url.Parse(server.URL)
		client := buckets.New(rest.NewClient(u, &http.Client{}, testr.New(t)), testr.New(t))
		data := []byte("{}")
